...
@Component({
  ...
  templateUrl: "./zaqvlenie.firma.component.html",
  styleUrls: ["./zaqvlenie.firma.component.scss"],
})
export class ZaqvlenieFirmaComponent implements OnInit {
  ...
  submitted = false;
  showMessages = true;
  nompreffix: string = (HeaderComponent.faza==1 ? "" : String(HeaderComponent.faza))+" "+"СО ОПОС_";
  idformulqr: number = 0;
  ...
  ngOnInit(): void {
    ...
    this.nomenclatureService.getNomenRaioni().subscribe((result) => {
      this.firmaraioni =result.map((item) => new ViewNom().convertNomRaion(item));
  ...
  loadApp() {
    this.licaService.getFormulqr(this.id).subscribe((result) => {
      this.nompreffix = (result.faza==1 ? "" : String(result.faza)+" ")+"СО ОПОС_";
      ...
      this.mainForm.patchValue({
        ...
        firma: {
          ...
          vidFirma: result.firma.vidFirma
            ? String(result.firma.vidFirma)
            : null,
          tipFirma: result.firma.tipFirma
            ? String(result.firma.tipFirma)
            : null,
          ident: result.firma.ident ? result.firma.ident : "",
          ime: result.firma.ime ? result.firma.ime : "",
          kodKID: result.firma.kodKID ? result.firma.kodKID : "",
          admRaion: result.firma.admRaion ? result.firma.admRaion : null,
          nasMqsto: result.firma.nasMqsto ? result.firma.nasMqsto : null,
          kvartal: result.firma.kvartal ? result.firma.kvartal : null,
          jk: result.firma.jk ? result.firma.jk : null,
          ulica: result.firma.ulica ? result.firma.ulica : null,
          nomer: result.firma.nomer ? result.firma.nomer : "",
          blok: result.firma.blok ? result.firma.blok : "",
          vhod: result.firma.vhod ? result.firma.vhod : "",
          etaj: result.firma.etaj ? result.firma.etaj : "",
          apart: result.firma.apart ? result.firma.apart : "",
          ...
          status: result.lice.status ? result.lice.status : 1,
          statusL: result.lice.statusL ? result.lice.statusL : 1,
        },
        nv9: result.nv9 ? String(result.nv9) : null,
        nv10: result.nv10 ? String(result.nv10) : null,
        ...
        nv19: result.nv19 ? String(result.nv19) : null,
        ...
        nv29: result.nv29 ? String(result.nv29) : null,
  ...
  back() {
    ...
    else this.router.navigateByUrl(this.routingState.getPreviousUrl());
  }
