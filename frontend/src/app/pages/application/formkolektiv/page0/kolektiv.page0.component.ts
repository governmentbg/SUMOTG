...
@Component({
  selector: 'ngx-kolektiv-page0',
  templateUrl: './kolektiv.page0.component.html',
  styleUrls: ['./kolektiv.page0.component.scss'],
})
export class KolektivPage0Component implements OnInit  {
