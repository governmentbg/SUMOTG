...
@Component({
  selector: 'ngx-kolektiv-page2',
  templateUrl: './kolektiv.page2.component.html',
  styleUrls: ['./kolektiv.page2.component.scss'],
})
export class KolektivPage2Component implements OnInit {
