...
@Component({
  selector: 'ngx-kolektiv-page4',
  templateUrl: './kolektiv.page4.component.html',
  styleUrls: ['./kolektiv.page4.component.scss'],
})
export class KolektivPage4Component implements OnInit {
