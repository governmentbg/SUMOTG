...
@Component({
  selector: 'ngx-kolektiv-page9',
  templateUrl: './kolektiv.page9.component.html',
  styleUrls: ['./kolektiv.page9.component.scss'],
})
export class KolektivPage9Component implements OnInit {
