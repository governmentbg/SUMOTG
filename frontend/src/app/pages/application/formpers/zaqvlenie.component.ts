...
import { CheckboxControlValueAccessor, FormArray, FormGroup } from "@angular/forms";
...
import { Address, Formulqr, LiceData, PersonItem } from "../../../@core/interfaces/common/lica";
...
@Component({
  ...
  templateUrl: "./zaqvlenie.component.html",
  styleUrls: ["./zaqvlenie.component.scss"],
})
export class ZaqvlenieComponent implements OnInit {
  ...
  loadApp() {            
    this.licaService.getHistoryFormulqr(this.id).subscribe((result) => {
    ...
    this.licaService.getFormulqr(this.id).subscribe((result) => {   
      ...
      this.mainForm.patchValue({
        ...
        lice: {
          ...
          admRaion: result.lice.admRaion ? result.lice.admRaion : null,
          nasMqsto: result.lice.nasMqsto ? result.lice.nasMqsto : null,
          kvartal: result.lice.kvartal ? result.lice.kvartal : null,
          jk: result.lice.jk ? result.lice.jk : null,
          ulica: result.lice.ulica ? result.lice.ulica : null,
          ...
          v7: result.lice.v7 ? result.lice.v7 : "",
  ...
  save() {
    ...
    let item: Formulqr = this.convertToFormulqr(this.mainForm.value);
...
/*********************/
  ...
  convertToFormulqr(value: any): Formulqr {
    ...
    //9 - anuliran
    if (formulqr.statusF === 9)
      formulqr.lice.statusL = 9;
    else
