...
@Component({
  selector: 'ngx-montazj',
  templateUrl: './montazj.component.html',
  styleUrls: ['./montazj.component.scss']
})
export class MontazjComponent implements OnInit {
  ...
  addItem() {
    const url = '/pages/firmcontracts/moncontract/0/Нов/0/' + this.isDisabled;
    this.router.navigateByUrl(url);
  }
