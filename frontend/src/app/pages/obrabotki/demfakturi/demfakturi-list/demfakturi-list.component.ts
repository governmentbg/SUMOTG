...
@Component({
  selector: 'ngx-demfakturi-list',
  templateUrl: './demfakturi-list.component.html',
  styleUrls: ['./demfakturi-list.component.scss']
})
export class DemfakturiListComponent implements OnInit {
  ...
  editItem($data: FakturiListItem) {
    const url = '/pages/obrabotki/demfakturiedit/' + 
                $data.idfirma + '/' + 
  ...
  addItem() {
    const url = '/pages/obrabotki/demfakturiedit/0/Новa/0/' + this.isDisabled;
    this.router.navigateByUrl(url);
  }
