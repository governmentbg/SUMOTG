...
import { FileToUpload, ObrabotkaData } from '../../../../@core/interfaces/common/obrabotki';
...
export class FileFackturaUploadDialogComponent implements OnInit {
  idDog: number = 0; 
  typeDoc: number = 0; 
  idFactura: number = 0; 
  EditForm: FormGroup;
  ...
  constructor(
    protected ref: NbDialogRef<FileFackturaUploadDialogComponent>,
  ...
  private readAndUploadFile() {
    ...
    reader.onload = () => {
        ...
        this.obrabotkiService.uploadFile(file).subscribe(resp => { 
