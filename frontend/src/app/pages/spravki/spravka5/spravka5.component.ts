...
@Component({
  selector: 'ngx-spravka5',
  templateUrl: './spravka5.component.html',
  styleUrls: ['./spravka5.component.scss']
})
export class Spravka5Component implements OnInit {
  filter: Filter;
  items: Spravka5 [] = [];
  realItems: Spravka5 [] = [];
  ...
  back() {
    this.router.navigate(['/pages/register/regfilter/14/'+this.filter.descript])
  }
}
