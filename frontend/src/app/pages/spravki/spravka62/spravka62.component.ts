...
@Component({
  selector: 'ngx-spravka62',
  templateUrl: './spravka62.component.html',
  styleUrls: ['./spravka62.component.scss']
})
export class Spravka62Component implements OnInit {
  filter: FilterA;
  items: Spravka60 [] = [];
  realItems: Spravka60 [] = [];
  ...
  pageSize = 10;
  countItems:number = 0;
  fileName= 'Списък на пропуснати профилактики';
  limit: number = 0;
